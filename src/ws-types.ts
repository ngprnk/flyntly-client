...
export type ServerMessage =
  ...
  | { type: 'message'; channelId: string; message: RawMessagePayload }
  | { type: 'message-edited'; channelId: string; message: RawMessageEditPayload }
  | { type: 'message_updated'; payload?: RawMessageUpdatePayload; messageId?: string; blocks?: unknown; pollData?: RawMessageUpdatePayload['pollData'] }
  | { type: 'message-deleted'; channelId: string; messageId: string }
  | { type: 'thread-added'; channelId: string; thread: RawThreadPayload }
  | { type: 'thread-edited'; channelId: string; thread: RawThreadPayload }
  | { type: 'thread-deleted'; channelId: string; threadId: string }
